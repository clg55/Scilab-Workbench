...
colors=['black','navyblue','blue','skyblue','aquamarine','forestgreen','green','lightcyan',...
	'cyan','orange','red','magenta','violet','yellow','gold','beige','white'];
...
lpat=list('patterns',pat+1,patterns);
lcols=list('colors',pat+1,colors);
