     ...
     float *x,*y,*w,*h,*wt,*ht;
{
  switch (num)
    ...
    case 2 :
      ...
      *x=0;*y=(20-(i-1)*10);*h=10;*w=15;
      break;
    case 3 :
      *wt=15;*ht=21;
      /** 3 figures dans upleft(0,21,h=21,w=15) **/
      *x=0;*y=(21-(i-1)*7);*h=7;*w=15;
      break;
    case 4 :

      /** 4 figures dans upleft **/
      *wt=16.0;*ht=16;
      if (i <= 2) *y=16;else *y=8;
      if ( (i % 2 ) == 0 ) 
	{ *x= 8;*h=8;*w=8;}
      else 
	{*x= 0;*h=8;*w=8;}
    ...
    case 6 :
      *wt=16.0;*ht=21;
      if (i <= 2) *y=21;else { if ( i <= 4) *y=14; else *y=7;};
      if ( (i % 2 ) == 0 ) 
	{ *x= 8.0;*h=7;*w=8;}
      else 
	{*x= 0 ;*h=7;*w=8;}
    ...
    case 9 :
      *wt=16;*ht=18;
      if (i <= 3) *y=18;else { if ( i <= 6) *y=12; else *y=6;};
      if ( (i % 3 ) == 0 ) 
	{ *x= 2*5.3;*h=6;*w=5.3;}
      else 
	{
