...
static void FileNameChange _PARAMS((char *filein,char *fileout,char *,char *));
static  void dos2win32 _PARAMS((char *filename,char *filename1));
int ScilabPsToTeX _PARAMS((char orientation,char *filenamein,char *filenameout,double xs,double ys));
