...
if bugnum(sprintf('%g',0.0000000345456),'3.45456e-08' ) then pause,end
if bugnum(sprintf('%g',11124234534545),'1.11242e+13' ) then pause,end
...
//test format '%e'
if bugnum(sprintf('%e',-35),'-3.500000e+01' ) then pause,end
if bugnum(sprintf('%e',35.55),'3.555000e+01' ) then pause,end
if bugnum(sprintf('%+e',35.55),'+3.555000e+01' ) then pause,end
if bugnum(sprintf('%e',35.551234567890),'3.555123e+01' ) then pause,end
if bugnum(sprintf('%e',0.00433),'4.330000e-03' ) then pause,end
if bugnum(sprintf('%e',0.0000000345456),'3.454560e-08' ) then pause,end
if bugnum(sprintf('%e',11124234534545),'1.112423e+13' ) then pause,end
if bugnum(sprintf('%E',11124234534545),'1.112423E+13' ) then pause,end

if bugnum(sprintf('%15e',-35),'  -3.500000e+01' ) then pause,end
if bugnum(sprintf('%15e',0.00433),'   4.330000e-03' ) then pause,end
if bugnum(sprintf('%15e',0.0000000345456),'   3.454560e-08' ) then pause,end
if bugnum(sprintf('%+15e',0.0000000345456),'   +3.454560e-08' ) then pause,end
