...
/* header du module de convolution de la transformee ondelettes continue */

/* Bertrand GUIHENEUF - FRACTALES 10/1996 */ 


#ifndef INCLUDE_CONVOL
#define INCLUDE_CONVOL
...
extern int CWT1D_Periodisation();


#undef OLD_FASHION_FILTERING
#ifdef OLD_FASHION_FILTERING
extern void CWT1D_Filtrage(double *ent, /* pointeur sur le tableau d'entree */
...
extern void CWT1D_Filtrage();
#endif /* OLD_FASHION_FILTERING */
#endif /* INCLUDE_CONVOL */
