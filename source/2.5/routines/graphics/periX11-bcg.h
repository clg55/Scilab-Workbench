...
void CreatePopupWindow  _PARAMS((integer WinNum,Widget top,struct BCG *, Pixel *fg,Pixel *bg));
extern void GViewportResize _PARAMS((struct BCG *ScilabXgc, int *width,int *height));
