...
#define SCI_VERSION_STRING "scilab-5.2.2"
/* SCI_VERSION_REVISION --> hash key commit */
#define SCI_VERSION_SVN_URL "svn://svn.scilab.org/scilab/branches/5.2/"
#define SCI_VERSION_GIT_URL "git://git.scilab.org/scilab"
#define SCI_VERSION_REVISION origin/5.2
#define SCI_VERSION_TIMESTAMP 1271678829
...
#define DEFAULT_SCI_VERSION_MESSAGE "scilab-5.2.2 (INRIA,ENPC)"
