...
#ifndef _AUTOMATIC_SUBTICKS_COMPUTER_HXX_
#define _AUTOMATIC_SUBTICKS_COMPUTER_HXX_
...
class AutomaticSubticksComputer : public ComputeSubticksStrategy
{
public:

  AutomaticSubticksComputer(DrawableSubwin * subwin);

  virtual ~AutomaticSubticksComputer(void);
...
#endif /* _AUTOMATIC_SUBTICKS_COMPUTER_HXX_ */
