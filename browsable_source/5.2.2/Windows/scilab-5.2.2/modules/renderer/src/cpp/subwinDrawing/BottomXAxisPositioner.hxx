...
#ifndef _BOTTOM_X_AXIS_POSITIONER_HXX_
#define _BOTTOM_X_AXIS_POSITIONER_HXX_
 ...
 */
class BottomXAxisPositioner : public XAxisPositioner
{
public:

  BottomXAxisPositioner(DrawableSubwin * subwin);

  virtual ~BottomXAxisPositioner(void);
