...
{ 
  ...
  /*--------------------A---------------------------*/
  GetRhsVar(A,MATRIX_OF_COMPLEX_DATATYPE, &M, &N, &lA); 
  CheckSquare(A, M, N);
  ...
  case 3: 
    ...
    JOBVS="V";
  /*--------------------W, VS, RWORK---------------------------*/
    CreateVar(W,MATRIX_OF_COMPLEX_DATATYPE, &N, &un, &lW);
    CreateVar(VS,MATRIX_OF_COMPLEX_DATATYPE, &N, &N, &lVS);
    CreateVar(RWORK,MATRIX_OF_DOUBLE_DATATYPE, &N, &un, &lRWORK);
  /*--------------------WORK---------------------------*/
    LWORKMIN = MAX(1, 2*N);
