function plot3di(x,y,z,T,A,leg,flags,ebox)
// intercative 3d plot
//!
default_leg='X@Y@Z'
default_flag=[2 1 4]
...
flags(2)=1;
plot3d(x,y,z,T,A,leg,flags,ebox)
...
while %t
  ...
  while rep(3)==-1 do
    ...
    c();plot3d(ebox(1),ebox(3),ebox(5),T,A,leg,flags,ebox);s()
  end
  c();plot3d(x,y,z,T,A,leg,flags,ebox);s()
end
