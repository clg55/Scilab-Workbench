...
"  fusee   - a set of macro for a fusee problem  ",
...
"  tangent   - linearization of a dynamical system at an equiibrium point  ",
"  tdinit   - interactive initialization of the tdcs dynamical systems ",
