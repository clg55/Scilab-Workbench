...
c     data imach( 7) /    2 /
c     data imach( 8) /   63 /
c     data imach( 9) / 922 3372 0368 5477 5807 /
c     data imach(10) /    2 /
c     data imach(11) /   48 /
c     data imach(12) /-4097 /
c     data imach(13) / 4094 /
c     data imach(14) /   48 /
c     data imach(15) /-4097 /
...
c     data imach(16) /  127 /
c
c     machine constants for the ibm 360/370 series, 3090/tso et vm
c     the ibm 4380/vm
...
c     data imach(16) /  63 /
c
c     machine constants for the gould sel/x32
c
c     data imach( 1) /   5 /
c     data imach( 2) /   6 /
c     data imach( 3) /   6 /
...
c     machine constants for the symbolics
c
      data imach( 1) /    5 /
      data imach( 2) /    6 /
      data imach( 3) /    5 /
...
c     data imach(16) / 1023 /
c
      if ( i.lt.1 .or. i.gt.16 ) go to 100
c
      i1mach=imach(i)
      return
c
  100 write(output,99)
   99 format(/,1x,'%% error in i1mach - i out of bounds')
      stop
      end
