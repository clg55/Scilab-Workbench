...
function [x,y,typ] = SRFLIPFLOP(job,arg1,arg2)
    ...
    case "set" then
        ...
        presentation = _("Set SR flip-flop block parameters<br><br>The ''Initial Value'' must be 0 or 1 of type int8<br>&nbsp;- Negative values are considered as int8(0)<br>&nbsp;- Positive values are considered as int8(1)<br><br>")
        while %t do
