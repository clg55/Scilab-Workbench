...
HDF5_SCILAB_IMPEXP hid_t createHDF5File(const char *name);
HDF5_SCILAB_IMPEXP hid_t openHDF5File(const char *name, int _iAppendMode);
HDF5_SCILAB_IMPEXP void closeHDF5File(hid_t file);
