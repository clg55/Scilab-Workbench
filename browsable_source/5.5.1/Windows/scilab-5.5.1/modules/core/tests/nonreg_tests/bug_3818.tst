...
if execstr('for k=1:2','errcatch')<>47 then pause,end
if execstr('for k=1:2,k','errcatch')<>47 then pause,end
if execstr('for k=1:','errcatch')<>2 then pause,end
if execstr('for k=[%f %t],k,end','errcatch')<>76 then pause,end
