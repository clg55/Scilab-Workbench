...
{ 
  ...
  short J=10,Q=21;
  int N_n=1024;
  double S_min=1,S_max=512,P_min=2,P_max=1024;
  MFAMt_part t_part=MFAM_LOGPART;
  /* input measure */
  double* mu_n=NULL;
  /* output powers, scales & partition function */
  double* q=NULL;
  double* a=NULL;
  double* Z_a_q=NULL;
  ...
  {
    InterfError("mdzq1d: You must give at least 2 input arguments\n");
    return;
  }
  if(Interf.NbParamIn>4) 
  {
    InterfError("mdzq1d: You must give at least 4 input arguments\n");
    return;
  }
  ...
  {
    InterfError("mdzq1d: You must give at most 1 output argument\n");
    return;
  }
  if(Interf.NbParamOut>2)
  {
    InterfError("mdzq1d: You must give at most 2 output arguments\n");
    return;
  }
  ...
  {
    InterfError("mdzq1d: The measure: mu_n must be a numeric matrix\n");
    return;
  }
  if(!MatrixIsReal(Mmu_n))
  {
    InterfError("mdzq1d: The measure: mu_n must be a real matrix\n");
    return;
  }
  ...
  {
    InterfError("mdzq1d: Call of the C function MFAL_mdZq1d error\n");
    return;
  } 
