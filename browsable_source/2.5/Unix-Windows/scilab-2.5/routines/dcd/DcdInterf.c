...
extern int C2F(cdfbet) _PARAMS((int *,double *,double *,double *,double *,double *,double *, int *,double *));
extern int C2F(cdfnbn) _PARAMS((int *,double *,double *,double *,double *,double *,double *, int *,double *));
extern int C2F(cdffnc) _PARAMS((int *,double *,double *,double *,double *,double *,double *, int *,double *));
extern int C2F(cdfbin) _PARAMS((int *,double *,double *,double *,double *,double *,double *, int *,double *));
extern int C2F(cdfchi) _PARAMS((int *,double *,double *,double *,double *, int *,double *));
extern int C2F(cdft) _PARAMS((int *,double *,double *,double *,double *, int *,double *));
extern int C2F(cdfpoi) _PARAMS((int *,double *,double *,double *,double *, int *,double *));
extern int C2F(cdff) _PARAMS((int *,double *,double *,double*,double *,double *, int *,double *));
extern int C2F(cdfgam) _PARAMS((int *,double *,double *,double*,double *,double *, int *,double *));
extern int C2F(cdff) _PARAMS((int *,double *,double *,double*,double *,double *, int *,double *));
extern int C2F(cdfchn) _PARAMS((int *,double *,double *,double*,double *,double *, int *,double *));
extern int C2F(cdfnor) _PARAMS((int *,double *,double *,double*,double *,double *, int *,double *));

static int CdfBase _PARAMS((char *fname,int inarg,int oarg,int *callpos,char *option,char *errnames,int which,int (*fonc)(),void (*foncErr)()));

static void cdfbetErr _PARAMS((int status,double bound));
static void cdfbinErr _PARAMS((int status,double bound));
static void cdfchiErr _PARAMS((int status,double bound));
static void cdffErr _PARAMS((int status,double bound));
static void cdffncErr _PARAMS((int status,double bound));
static void cdfgamErr _PARAMS((int status,double bound));
static void cdfnbnErr _PARAMS((int status,double bound));
static void cdfnorErr _PARAMS((int status,double bound));
static void cdfpoiErr _PARAMS((int status,double bound));
static void cdftErr _PARAMS((int status,double bound));
static void cdfchnErr _PARAMS((int status,double bound));
