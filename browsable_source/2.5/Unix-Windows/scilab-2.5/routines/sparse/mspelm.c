...
integer *id;
{
    ...
    extern  int F2C(dcopy)(), F2C(icopy)(), F2C(error)();
	...
	*istk(il ) = 7;
	...
	I1 = nel * (it + 1);
	F2C(dcopy)(&I1, stk(lat ), &c1, stk(lr ), &
		c1);
...
integer *id;
{
	...
	*istk(il + 3) = 0;
	...
	printf("%f\n",stk(l+3));
	printf("vvvvvvvvvvvvvvvvvv\n"); */
	F2C(dcopy)(&I1, stk(l ), &c1, stk(lv ), &c1);
    } else {
	I1 = nel * (it + 1);
	...
	F2C(dcopy)(&I1, stk(l ), &c_n1, stk(lv ), &c_n1);
    }
     ...
     integer *id;
{
    ...
    I1 = nel * (it + 1);
    F2C(dcopy)(&I1, stk(l ), &c1, stk(ls ), &c1);
    *istk(il ) = 1;
    I1 = il + 4;
    l = I1 / 2 + 1;
    if (it == 0) {
