...
if bugnum(Fprintf('%g',0.0000000345456),'3.45456e-08' ) then pause,end
if bugnum(Fprintf('%g',11124234534545),'1.11242e+13' ) then pause,end

if bugnum(Fprintf('%15g',-35),'            -35' ) then pause,end
if bugnum(Fprintf('%15g',0.00433),'        0.00433','         .00433' ) then pause,end
if bugnum(Fprintf('%15g',0.0000000345456),'    3.45456e-08' ) then pause,end
if bugnum(Fprintf('%15g',11124234534545),'    1.11242e+13' ) then pause,end

if bugnum(Fprintf('%.1g',-35.1),'-4e+01' ) then pause,end
if bugnum(Fprintf('%.0g',-35.1),'-4e+01' ) then pause,end
if bugnum(Fprintf('%#.0g',-35.1),'-4.e+01' ) then pause,end
if bugnum(Fprintf('%#.0G',-35.1),'-4.E+01' ) then pause,end
if bugnum(Fprintf('%.1g',0.00433),'0.004' ,' .004' ) then pause,end
if bugnum(Fprintf('%.15g',0.0000000345456),'3.45456e-08' ) then pause,end
if bugnum(Fprintf('%.1g',11124234534545),'1e+13' ) then pause,end

//----------test format '%e'
if bugnum(Fprintf('%e',-35),'-3.500000e+01' ) then pause,end
if bugnum(Fprintf('%e',35.55),'3.555000e+01' ) then pause,end
if bugnum(Fprintf('%+e',35.55),'+3.555000e+01' ) then pause,end
if bugnum(Fprintf('%e',35.551234567890),'3.555123e+01' ) then pause,end
if bugnum(Fprintf('%e',0.00433),'4.330000e-03' ) then pause,end
if bugnum(Fprintf('%e',0.0000000345456),'3.454560e-08' ) then pause,end
if bugnum(Fprintf('%e',11124234534545),'1.112423e+13' ) then pause,end
if bugnum(Fprintf('%E',11124234534545),'1.112423E+13' ) then pause,end

if bugnum(Fprintf('%15e',-35),'  -3.500000e+01' ) then pause,end
if bugnum(Fprintf('%15e',0.00433),'   4.330000e-03' ) then pause,end
if bugnum(Fprintf('%15e',0.0000000345456),'   3.454560e-08' ) then pause,end
if bugnum(Fprintf('%+15e',0.0000000345456),'  +3.454560e-08' ) then pause,end
if bugnum(Fprintf('%15e',11124234534545),'   1.112423e+13' ) then pause,end

if bugnum(Fprintf('%.1e',-35),'-3.5e+01' ) then pause,end
if bugnum(Fprintf('%.0e',-35.1),'-4e+01' ) then pause,end
if bugnum(Fprintf('%#.0e',-35.1),'-4.e+01' ) then pause,end
if bugnum(Fprintf('%.1e',0.00433),'4.3e-03' ) then pause,end
if bugnum(Fprintf('%.15e',0.0000000345456),'3.454560000000000e-08' ) then pause,end
if bugnum(Fprintf('%.1e',11124234534545),'1.1e+13' ) then pause,end
