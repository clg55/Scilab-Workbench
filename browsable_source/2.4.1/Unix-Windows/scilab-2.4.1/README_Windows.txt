                Scilab version 2.4.1 for Windows (NT/95)
                ****************************************
...
**********************************
   ...
   1 - You have already installed Scilab by executing "scilab241.exe".
       By default Scilab is in "C:\Program Files\Scilab-2.4.1" directory.
   ...
   3 - Scilab has been compiled with Visual C++ 5.0 (see IV below).
...
*****************************************
   ...
   "Scilab 2.4.1" item of the Program Group.
   ...
   "C:\Program Files\Scilab-2.4.1"), the "Scilab 2.4.1" directory in the
   Program Group (usually "C:\Windows\Start Menu\Programs\Scilab2.4.1" on
