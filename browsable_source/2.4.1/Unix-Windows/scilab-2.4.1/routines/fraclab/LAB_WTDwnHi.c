...
/************  LAB_WTDwnHi **************************************************/
/* routine to call to compute the convolution of signal by a high pass      */
/* filter followed by a downsampling                                        */
/* Usage [Out] = WTDwnHi(In, QMF)                                           */
/* Where :                                                                  */
/*                                                                          */
...

{
  ...
  t_filtre FilterHi; /* and the HighPass */
  int i; /* a counter */
  ...
  /* compute the highPass filter */
  calcul_filtre_conjugue(&Filter, &FilterHi);
  ...
  Filtrage(Input, Output, InputSize, &FilterHi, WT_Periodisation); 
