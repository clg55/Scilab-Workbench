                Scilab version 3.1.1 for Windows (98/2000/XP)
                ***********************************************
...
******************************************************************************
    ...
    1 - You have already installed Scilab by executing "scilab-3.1.1.exe".
        By default Scilab is in "C:\Program Files\scilab-3.1.1" directory.
 
    2 - Run Scilab by executing "Scilab 3.1.1" from the startup menu.
    ...
    4 - If you want use LCC-Win32 (C compiler) with Scilab 3.1.1
...
******************************************************************************
    ...
    "Scilab 3.1.1" item of the Program Group.
