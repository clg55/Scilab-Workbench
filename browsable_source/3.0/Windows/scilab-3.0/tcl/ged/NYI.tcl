...
frame $w.frame.lbl -borderwidth 0
pack $w.frame.lbl -in $w.frame  -side top -fill x
message  $w.frame.meslbl  -justify left -text " Unfortunatly, this type of entity is not yet implemented in the Graphic Editor. \ A complete graphic editor will be available soon."
