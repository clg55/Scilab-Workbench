...
//
h1=num/den;x=1.5;
if cmpr(h1+x,list('r',num+x*den,den,[]),eps)<>1 then pause,end
if cmpr(x+h1,list('r',num+x*den,den,[]),eps)<>1 then pause,end
if cmpr(h1-x,list('r',num-x*den,den,[]),eps)<>1 then pause,end
if cmpr(x-h1,list('r',-num+x*den,den,[]),eps)<>1 then pause,end
...
if cmpr(x-h1,list('r',-num+x*den,den,[]),eps)<>1 then pause,end
y=s**3;h2=x/y;
if cmpr(h1+h2,list('r',num*y+x*den,den*y,[]),eps)<>1 then pause,end
if cmpr(h1-h2,list('r',num*y-x*den,den*y,[]),eps)<>1 then pause,end
//
// concatenations
//
h1=num/den;x=1.5;
if cmpr([h1,x],list('r',[num,x],[den,1],[]),eps)<>1 then pause,end
if cmpr([x,h1],list('r',[x,num],[1,den],[]),eps)<>1 then pause,end
if cmpr([h1;x],list('r',[num;x],[den;1],[]),eps)<>1 then pause,end
if cmpr([x;h1],list('r',[x;num],[1;den],[]),eps)<>1 then pause,end
x=1.5+3*s;
if cmpr([h1,x],list('r',[num,x],[den,1],[]),eps)<>1 then pause,end
...
if cmpr([x;h1],list('r',[x;num],[1;den],[]),eps)<>1 then pause,end
y=-0.5+s**3;h2=x/y;
if cmpr([h1,h2],list('r',[num,x],[den,y],[]),eps)<>1 then pause,end
if cmpr([h1;h2],list('r',[num;x],[den;y],[]),eps)<>1 then pause,end
h1=[num/den,den/num];x=[0.3 1.5];
if cmpr([h1,x],list('r',[h1(2),x],[h1(3),ones(x)],[]),eps)<>1 then pause,end
if cmpr([x,h1],list('r',[x,h1(2)],[ones(x),h1(3)],[]),eps)<>1 then pause,end
if cmpr([h1;x],list('r',[h1(2);x],[h1(3);ones(x)],[]),eps)<>1 then pause,end
if cmpr([x;h1],list('r',[x;h1(2)],[ones(x);h1(3)],[]),eps)<>1 then pause,end
h1=[num/den;den/num];x=[0.3;-1.5];
if cmpr([h1,x],list('r',[h1(2),x],[h1(3),ones(x)],[]),eps)<>1 then pause,end
...
if cmpr([h1,h2],list('r',[h1(2),h2(2)],[h1(3),h2(3)],[]),eps)<>1 then pause,end
if cmpr([h1;h2],list('r',[h1(2);h2(2)],[h1(3);h2(3)],[]),eps)<>1 then pause,end
h1=[num/den,den/num];y=-0.5+s**3;h2=[num/y,y*y/(y+1)];
if cmpr([h1,h2],list('r',[h1(2),h2(2)],[h1(3),h2(3)],[]),eps)<>1 then pause,end
if cmpr([h1;h2],list('r',[h1(2);h2(2)],[h1(3);h2(3)],[]),eps)<>1 then pause,end
