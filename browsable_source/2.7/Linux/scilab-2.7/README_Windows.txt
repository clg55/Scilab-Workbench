...
**********************************
    ...
    4 - You can try to use PVM. For that, execute the file "pvmconf.bat"
        which is in "Scilab-2.7" folder in order to modify the configuration
        file ".pvmd.conf". PVM is not guaranteed to work.
