...
A =     %c_a_c.sci %hm_a_hm.sci %hm_a_s.sci %ip_a_s.sci \
	...
	%sp_a_sp.sci %i_a_i.sci %c_i_s.sci %mc_i_s.sci \
	%st_i_s.sci	
...
C =      %b_c_spb.sci %c_i_c.sci %hm_c_hm.sci %l_n_c.sci \
	 ...
	 %c_c_cblock.sci %cblock_c_cblock.sci %s_c_cblock.sci \
	 %cblock_c_s.sci
...
O =      %hm_o_hm.sci %hm_o_s.sci %ip_o_ip.sci %l_o_p.sci \
