...
c
c!
c this is the august 13, 1981 version of lsode.
c-----------------------------------------------------------------------
...
c
 430  ntrep = ntrep + 1
      ...
      call xerrwv(
     1  'lsode--  calls with istate = 1 and tout = t (=r1)  ',
...
c-----------------------------------------------------------------------
 ...
 613  call xerrwv('lsode--  mxhnil (=i1) .lt. 0  ',
     1   30, 13, 1, 1, mxhnil, 0, 0, 0.0d+0, 0.0d+0)
      go to 700
 614  call xerrwv('lsode--  tout (=r1)  .gt.  t (=r2)      ',
 ...
 616  call xerrwv('lsode--  hmin (=r1) .lt. 0.0  ',
     1   30, 16, 1, 0, 0, 0, 1, hmin, 0.0d+0)
      go to 700
 617  call xerrwv(
     1 'lsode-- necessary size for rwork (i1) larger than i2',
 ...
 621  ewti = rwork(lewt+i-1)
     ...
     1   40, 21, 1, 1, i, 0, 1, ewti, 0.0d+0)
      go to 700
 622  call xerrwv(
     1  'lsode--  tout (=r1) too close to t(=r2) ',
     1   60, 22, 1, 0, 0, 0, 2, tout, t)
      go to 700
 623  call xerrwv(
     1  'lsode--  itask (=i1) and tout (=r1) .gt. tcur - hu (= r2)  ',
     1   60, 23, 1, 1, itask, 0, 2, tout, tp)
      go to 700
 624  call xerrwv(
     1  'lsode--  itask = 4 or 5 and tcrit (=r1) .gt. tcur (=r2)   ',
 ...
 626  call xerrwv('lsode-- initial precision required',
     1   50, 26, 1, 0, 0, 0, 0, 0.0d+0, 0.0d+0)
      call xerrwv(
     1 'too high wrt machine precision tolsf (=r1)',
     1   60, 26, 1, 0, 0, 0, 1, tolsf, 0.0d+0)
      rwork(14) = tolsf
      go to 700
 627  call xerrwv('lsode--  problems in intdy. itask=i1,tout=r1',
...
c
 700  if (illin .eq. 5) go to 710
      ...
      istate = -3
      return
 710  call xerrwv('lsode-- incorrect inputs',
     1   50, 302, 1, 0, 0, 0, 0, 0.0d+0, 0.0d+0)
c
 800  call xerrwv('lsode-- infinite loop ',
