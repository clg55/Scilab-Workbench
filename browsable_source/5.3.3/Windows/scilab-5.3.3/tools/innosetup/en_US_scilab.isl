...
en_US.MsgBoxTclsciRequired1 =You choose to install Scipad but tclsci module is not selected.
...
;
en_US.DescriptionEquDif =Differential Equations Module
en_US.DescriptionInterpolation =Interpolation Module
en_US.DescriptionPolynomials =Polynomials Module
en_US.DescriptionSymbolic =Symbolic Module
en_US.DescriptionStats =Statistics Module
en_US.DescriptionSparse =Sparse Matrix Module
en_US.DescriptionLinAlg =Linear Algebra Module
en_US.DescriptionSigProc =Signal processing Module
en_US.DescriptionCacsd =C.A.C.S.D Module
en_US.DescriptionGraphics =Graphics Module
en_US.DescriptionOptim =Optimization Module
en_US.DescriptionMetanet =Metanet Toolbox
en_US.DescriptionScicos =Scicos Toolbox
en_US.DescriptionArnoldi =ARnoldi PACKage Toolbox
en_US.DescriptionUmfpack =UMFPACK for Scilab
...
en_US.DescriptionTexmacs =Texmacs Interface
en_US.DescriptionSound =Sound file handling Toolbox
en_US.DescriptionRandlib =Randlib Toolbox
en_US.DescriptionJavasci =Java Interface with Scilab
en_US.DescriptionMexlib =Mexlib Tools
en_US.DescriptionIntersci =Intersci Toolbox
en_US.DescriptionMaple2sci =Maple to Scilab Toolbox
en_US.DescriptionFortran2sci =Scilab to Fortran Toolbox
en_US.DescriptionTclTK =TCL/TK in Scilab
en_US.DescriptionScipad =Scipad Editor for Scilab
en_US.DescriptionSpreadsheet =Spreadsheet Toolbox
en_US.DescriptionPvm =PVM Parallel Toolbox
...
en_US.DescriptionParametersTlbx =Parameters Toolbox
en_US.DescriptionGeneticTlbx =Genetic Algorithms Toolbox
en_US.DescriptionSimulAnnealingTlbx =Simulated Annealing Toolbox
...
en_US.DescriptionComConnector = COM connector
en_US.DescriptionSciNotes = SciNotes: Editor for Scilab
