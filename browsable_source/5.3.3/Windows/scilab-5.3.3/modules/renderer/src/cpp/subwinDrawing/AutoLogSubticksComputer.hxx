...
#ifndef _AUTO_LOG_SUBTICKS_COMPUTER_HXX_
#define _AUTO_LOG_SUBTICKS_COMPUTER_HXX_
...
class AutoLogSubticksComputer : public ComputeSubticksStrategy
{
public:

  AutoLogSubticksComputer(DrawableSubwin * subwin);

  virtual ~AutoLogSubticksComputer(void);
...
#endif /* _AUTO_LOG_SUBTICKS_COMPUTER_HXX_ */
