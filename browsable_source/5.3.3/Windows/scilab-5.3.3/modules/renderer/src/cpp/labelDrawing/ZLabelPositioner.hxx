...
#ifndef _Z_LABEL_POSITIONER_HXX_ 
#define _Z_LABEL_POSITIONER_HXX_
...
class ZLabelPositioner : public LabelPositioner
{
public:

  ZLabelPositioner(DrawableLabel * label);

  virtual ~ZLabelPositioner(void);
...
#endif /* _Z_LABEL_POSITIONER_HXX_ */
