...
import org.scilab.modules.renderer.utils.MarkDrawing.*;
 ...
 */
public class GL2PSMarkDrawingStrategy extends MarkDrawingStrategy {

	/**
	 * Default constructor
	 */
	public GL2PSMarkDrawingStrategy() { }
	...
	public MarkDrawingStrategy create(int markStyleIndex) {
		...
		case DOT:
		    res = new GL2PSDotMarkDrawer();//MarkDrawingStrategy("circle");
			break;
		case PLUS:
