...
public final class AlignBlockActionRight extends AlignBlockAction {
	...
	public static final String SMALL_ICON = "align-horizontal-right.png";
	 ...
	 */
	public AlignBlockActionRight(ScilabGraph scilabGraph) {
		super(scilabGraph, XcosConstants.ALIGN_RIGHT);
	}
	...
	public static MenuItem createMenu(ScilabGraph scilabGraph) {
		return createMenu(scilabGraph, AlignBlockActionRight.class);
	}
}
