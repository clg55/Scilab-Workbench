...
if execstr("x=ode(1,0,0:0.1:0.3,list(1,0.9))","errcatch")<>80 then pause,end



if execstr("x=ode(1,0,0:0.1:0.3,list(flin,0.9),list(jlin,0.9))","errcatch")<>0 then pause,end

if execstr("x=ode(1,0,0:0.1:0.3,list(flin,0.9),list(1,0.9))","errcatch")<>80 then pause,end
if execstr("x=ode(1,0,0:0.1:0.3,list(1,0.9),list(jlin,0.9))","errcatch")<>80 then pause,end
...
if execstr("x=ode(""root"",1,0,0:0.1:0.3,list(flin,0.9),1,list(1,0))","errcatch")<>80 then pause,end
