...
//      file('last',unit)
      nt=size(t__);for i=1:nt, write(%io(2),t__(i),'(a)'), end,
//      file('close',unit)
end;end;
...
//
 case 10 then // matrice de chaines de caracteres
  ...
  t__=[t__ ; str2map(nom,a,ma,na)]
//
 case 11 then // macro non compilee
 comp(a)
 tramac(nom,a,b_2_m)
//
 case 13 then // macro compilee
 tramac(nom,a,b_2_m)
//
 case 15 then //listes
   select a(1)
