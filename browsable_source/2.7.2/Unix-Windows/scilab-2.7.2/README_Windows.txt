                Scilab version 2.7.2 for Windows (95/98/NT/2000/XP)
                *************************************************
...
**********************************
    ...
    1 - You have already installed Scilab by executing "scilab-2.7.2.exe".
        By default Scilab is in "C:\Program Files\Scilab-2.7.2" directory.
...
CAUTION: When Scilab 2.7.2 is launched, file "scilab.hist" is created. By default it
********
...
the folder it defines: Scilab 2.7.2 crashes. To solve this problem you have to
...
*****************************************
    ...
    "Scilab 2.71" item of the Program Group.
