...
static void set_std_color  _PARAMS((Widget w, XtPointer number, XButtonEvent *ev));  
static void choice_panel_cancel  _PARAMS((Widget w, char *dum, XButtonEvent *ev));  
static void set_color_ok  _PARAMS((Widget w, int number, XButtonEvent *ev));  
