...
addinter(a set of object files (thisinterfaceroutine.o + your C objectfiles.o),
   ...
   [y1,y2,...y_maxlhs]=scilabfunctionname1(x1,x2,...,x_maxrhs)

   [y1,y2,...y_      ]=scilabfunctionname2(x1,x2,...,x_      )
...
{ /* Declare a number of variables */
  ...
  static int minlhs=?, minrhs=?, maxlhs=?, maxrhs=?;
...
static TabF Tab[]={ interface1, "scilabfunction1", interface2, "scilabfunction2",} ; 
