...
/* 	$Id: C-LAB_Interf.c,v 1.5 1998/02/25 20:38:01 guiheneu Exp $	 */

#ifndef lint
static char vcid[] = "$Id: C-LAB_Interf.c,v 1.5 1998/02/25 20:38:01 guiheneu Exp $";
#endif /* lint */
...

{
  ...
  F2C(cvstr)(&strsiz, prefix + 6, outstr, &op );
  outstr[strsiz]='\0';
...

{
  ...
  if (strsiz>0) {
    ...
    F2C(cvstr)(&strsiz, prefix + 6, s, &op);
  }
    return(m); 
