...
extern ldc_liste_chainee ldc_creer _PARAMS((int (*correspondre) (), void (*desallouer) (), void (*liberer) (), void *(*allouer) ()));

/* Destruction d'une liste chainee. La destruction appelle la procedure desallouer()
   pour chaque element de la liste. */
extern void ldc_detruire _PARAMS((ldc_liste_chainee liste));

ldc_objet_liste ldc_objet_suivant _PARAMS((ldc_liste_chainee liste, ldc_element_correspondance correspondance));

ldc_objet_liste ldc_objet_precedent _PARAMS( (ldc_liste_chainee liste, ldc_element_correspondance correspondance));

extern void ldc_ajouter_objet _PARAMS( (ldc_liste_chainee liste, ldc_objet_liste objet));
...
int ldc_supprimer_objet _PARAMS( (ldc_liste_chainee liste, ldc_objet_liste objet));
...
ldc_objet_liste ldc_rechercher_objet _PARAMS( (ldc_liste_chainee liste, ldc_element_correspondance correspondance));

/* Application d'une fonction sur l'ensemble des objets d'une liste */
void ldc_appliquer_liste _PARAMS( (ldc_liste_chainee liste, void (*fonction_sur_objet) (/* ??? */)));
