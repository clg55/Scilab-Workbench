...
norm(xlast-expm(A*xft(1,q))*x0)

//itask=3;   ---> solution at first mesh point beyond t=tmax
%ODEOPTIONS(1)=3;
x3=ode(x0,t0,tmax,f);
norm(x3(2:nx+1)-xlast,1)
...
[p,q]=size(x42);
norm(x42(:,q)-ode(x0,t0,tcrit,f),1)
