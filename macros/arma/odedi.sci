...
//!
write(%io(2),"Test of ode and arsimul")
ero_n=0
y=ode('discret',2,1,2:4,ttt);y=[2,y];
if y=[2,4,16,256] then 
  v=1;
else 
   write(%io(2),"[1]problem with ode and option discret");ero_n=ero_n+1
end
// autre test
...
if y=(1:10) then
  ...
  write(%io(2),"[2]problem with ode and option discret");ero_n=ero_n+1
end
y=arsimul([1],[0,1],[0],0,1:10);
if y=[0,1:9] then 
   v=1; 
else 
 write(%io(2),"[3]problem with ode and option discret");ero_n=ero_n+1
end
