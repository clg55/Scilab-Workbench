function [xi,xa,np]=graduat( xmi, xma,n1,n2)
// graduat - axis pretty graduations
//%Syntax
// [xa,xi,np]=graduat( xma, xmi,n1,n2)	
// [xa,xi,np]=graduat( xma, xmi)	
//%Parameters
...
// np       :integer scalar
//%Description
// graduat looks for the mimimum interval [xi,xa] and a number of tics np
// such that:
//           xi <= xmi <= xma <= xa
...
//  [ymn,ymx,np]=graduat(mini(y),maxi(y))
