function ppath=getparpath(x,bpath,ppath)
// getparpath - computes path to block parameter data structure in scicos structure
//%Syntax
//  ppath=getparpath(x)  standard call
//  ppath=getparpath(x,bpath,ppath) recursive call
//%Parameters
//   x     : scicos data structure
//   bpath : current path to x
