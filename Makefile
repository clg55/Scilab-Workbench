...
SCIVERSION = Scilab-2.1
SCIDATE = 10 February 1995
...
DEFAULTS=routines/default/interf.o routines/default/bidon.o \
	...
	routines/default/fsurf.o \
	routines/default/fresd.o routines/default/fjacd.o \
	routines/default/fcol.o \
	routines/default/icsemc.o \
	routines/default/scilab.o \
	routines/default/matlab.o \
...
bin/scilex:   \
	...
	if [ $$x -ne 0 ] ; then \
			...
			echo "linking";\
			$(FC) -o $@   \
	$(DEFAULTS) $(LIBR) $(FLDOPTIONS)  $(XAWLIB) $(XMULIB) $(XTOOLLIB) $(XLIB) $(LDLIBS) -ltermcap $(EXTRA_LOAD_FLAGS) ;\
	else \
...
scilex-lib::
	...
	for i in routines ;\
	do \
		(cd $$i ; echo "making" scilex-lib "in $(CURRENT_DIR)/$$i..."; \
			$(MAKE) $(MFLAGS) CDEBUGFLAGS='$(CDEBUGFLAGS)' FDEBUGFLAGS='$(FDEBUGFLAGS)' all); \
	done
...
distclean::
	@case '${MFLAGS}' in *[ik]*) set +e;; esac; \
	for i in $(SUBDIRS) tests ;\
	do \
		(cd $$i ; echo "making" distclean "in $(CURRENT_DIR)/$$i..."; \
