...
int nnuees(x, y, z, n, bx, by, bz, nbbary, chaine, ierr)
double *x, *y, *z;
integer *n;
double *bx, *by, *bz;
integer *nbbary, *chaine, *ierr;
{
    ...
    /*   en entree 
	 n      points x,y,z 
	 nbbary bary_centres initiaux bx,by,bz 
	 en sortie 
	 les nbbary bary_centres trouves  bx,by,bz 
	 chaine(i) pointe sur le bary_centre auquel le point 
                   x(i),y(i),z(i) appartient 
    */
...
int bblocs(x, y, z, n, bx, by, bz, nbbary, chaine, ierr)
double *x, *y, *z;
integer *n;
double *bx, *by, *bz;
integer *nbbary, *chaine, *ierr;
{
    ...
    /* Local variables */
    static integer bmin[256], bmax[256], rang, dmax, kmin, tete[256], rmin[
	    256], rmax[256], vmin[256], vmax[256], next, b, i, j, k, m, r,
	     v, w, itmax, histo[256];
    extern int heapi2();
