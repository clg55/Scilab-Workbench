...
int SciChoiceI _PARAMS((char *label,int defval[],int nitems));
int SciChoiceCreate _PARAMS((char **items,int defval[],int nitems));
int AllocAndCopy _PARAMS((char **strh1,char *str2));
int SciChoiceFree _PARAMS((int nitems));
int mChoiceWindow _PARAMS((void));

/*  "wmen_choose-n.c.X1" */

EXPORT BOOL CALLBACK TestDlgProc  _PARAMS((HWND , UINT , WPARAM , LPARAM ));
   
extern int ExposeChooseWindow _PARAMS((ChooseMenu *PCh));

/*  "wmen_dialog-n.c.X1" */
EXPORT int CALLBACK  SciDialogDlgProc  _PARAMS((HWND hdlg, UINT wmsg, WPARAM wparam, LPARAM lparam));  
extern BOOL DialogWindow  _PARAMS((void));  
...
int mDialogWindow _PARAMS((void)); 

/*  "wmen_message-n.c.X1" */

EXPORT BOOL CALLBACK SciMessageDlgProc  _PARAMS((HWND hdlg, UINT wmsg, WPARAM wparam, LPARAM lparam));
