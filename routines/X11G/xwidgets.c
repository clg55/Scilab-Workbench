...
static integer testC1() { TestC(2);}
static integer testC2() { TestC(0);}
static integer testC3() { TestC(1);}


#define XNCh 21
#define YNCh 21

static integer testCh()
{
...
XtPointer junk, garbage;
{
  ...
  while ( testtab[i].name != (char *) NULL)
     {
       if (streq(XtName(w), testtab[i].name)) 
	 {
	   (*(testtab[i].fonc))();
	 }
       i++;
